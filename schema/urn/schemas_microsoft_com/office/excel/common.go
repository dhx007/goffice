...
func init() {
	goffice.RegisterConstructor("urn:schemas-microsoft-com:office:excel", "CT_ClientData", NewCT_ClientData)
	goffice.RegisterConstructor("urn:schemas-microsoft-com:office:excel", "ClientData", NewClientData)
}
