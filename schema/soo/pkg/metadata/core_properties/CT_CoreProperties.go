...
type CT_CoreProperties struct {
	...
	Created        *goffice.XSDAny
	Creator        *goffice.XSDAny
	Description    *goffice.XSDAny
	Identifier     *goffice.XSDAny
	Keywords       *CT_Keywords
	Language       *goffice.XSDAny
	LastModifiedBy *string
	LastPrinted    *time.Time
	Modified       *goffice.XSDAny
	Revision       *string
	Subject        *goffice.XSDAny
	Title          *goffice.XSDAny
	Version        *string
}
...
func (m *CT_CoreProperties) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if m.Category != nil {
		...
		goffice.AddPreserveSpaceAttr(&secategory, *m.Category)
	...
	if m.ContentStatus != nil {
		...
		goffice.AddPreserveSpaceAttr(&secontentStatus, *m.ContentStatus)
	...
	if m.LastModifiedBy != nil {
		...
		goffice.AddPreserveSpaceAttr(&selastModifiedBy, *m.LastModifiedBy)
	...
	if m.Revision != nil {
		...
		goffice.AddPreserveSpaceAttr(&serevision, *m.Revision)
	...
	if m.Version != nil {
		...
		goffice.AddPreserveSpaceAttr(&seversion, *m.Version)
...
lCT_CoreProperties:
	for {
		...
		case xml.StartElement:
			...
			default:
				goffice.Log("skipping unsupported element on CT_CoreProperties %v", el.Name)
